...
while True:
    ...
    if objects > 0:
        ...
        filename = f"/home/kiran/Camera/Videos/Video_{capture_count}_{timestamp}.mp4"
        #picam2.capture_file(filename)
        picam2.start_and_record_video(filename, duration=8)
        #picam2.stop_preview()
        capture_count +=1
        print("Video Completed >> ",filename)
        print("\n")
